...
filename = file.path(results_dir(), "conditional-adjustment-fixed-rho_b.rds") # Where to store results
...
# Load the already estimated value of θ* from the previous simulation study
...
theta_star = readRDS(theta_star_filename)[-3]
